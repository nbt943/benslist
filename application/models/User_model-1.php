...
public function new_user_signup($user_email,$user_password)
    {    
  ...
  public function get_setting_profile($id)
    ...
    public function update_profile_setting($id,$username,$user_pass,$first_name,$last_name,$phone,$user_pass,$new_name)
    { 
      ...
      {        
       ...
       $data = array( 
        ...
        $this->db->where('ID',$id);
        $row = $this->db->update('ben_users',$data); print_r($data);
  ...
  // {
   ...
   // {
    ...
    // else
    // {
     // return 'Please verify your email adrress';
    // }
   // }
  // }
  // else
