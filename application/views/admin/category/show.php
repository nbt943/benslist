...
?>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="box-body">
                ...
                <tbody> 
                  <?php if($categories){ ?>
                  <?php $i = 1; foreach ($categories as $category) { if($category['status']=='1'){ ?>
                <tr>
                  <td><?php echo $i++ ?></td>
                  ...
                  <td>
                    <a href="<?php echo base_url('admin/category/edit/'.$category['ID']) ?>" class="btn"><i class="fa fa-edit" title="Edit"></i></a>          
                     <a id="<?php echo $category['ID'] ?>" class="btn delete-category"><i class="fa fa-trash" title="Trash"></i></a>
                  </td>
                  </tr>
                  <?php } } } ?>    
                </tbody>                 
 ...
 <script>
  ...
  $('body').on('click','.delete-category', function(){
    ...
    {
      var id = $(this).attr('id');
      window.location.href = "<?php echo base_url('admin/category/deleted/') ?>"+id+" ";
    }
  });
</script>