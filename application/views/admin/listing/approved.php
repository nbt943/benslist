    ...
    ?>          
              ...
              <?php $i=1; foreach ($listings as $key => $listing) {  ?>
                <tr>
                  ...
                  <td><?php if($listing['status'] == '1'){ echo "Approved"; } ?></td>
                  <td>  
                    <a id="<?php echo $listing['ID'] ?>DIS" class="btn disapprove-btn"><i class="fa fa-thumbs-down" title="Make it disapprove"></i></a>           
                  </td>
                  </tr>  
