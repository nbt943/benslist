    ...
    ?>          
              ...
              <?php $i=1; foreach ($listings as $key => $listing) {  ?>
                <tr>
                  ...
                  <td><?php if($listing['status'] == '2'){ echo "Disapproved"; } ?></td>
                  <td> 
                    <a id="<?php echo $listing['ID'] ?>APP" class="btn approve-btn"><i class="fa fa-thumbs-up" title="Approved" ></i></a>   
                     <a id="<?php echo $listing['ID'] ?>" class="btn delete-btn"><i class="fa fa-trash" title="Permanent Delete" ></i></a>         
                  </td>
                  </tr>  
