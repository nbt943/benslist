...
?>
    ...
    ?>					
              ...
              <div class="box-body">
                ...
                <tbody> 
                  ...
                  <?php $i = 1; foreach ($subcategories as $subcategory) { if($subcategory['status']=='1'){ ?>
                <tr>
                  <td><?php echo $i++ ?></td>                  
                  ...
                  <td>
                    <a href="<?php echo base_url('admin/sub-category/edit/'.$subcategory['ID']) ?>" class="btn"><i class="fa fa-edit" title="Edit"></i></a>          
                     <a id="<?php echo $subcategory['ID'] ?>" class="btn delete-sub-category"><i class="fa fa-trash" title="Trash"></i></a>
                  </td>
                  </tr>
                  <?php } } } ?>    
                </tbody>                 
 ...
 <script>
  ...
  $('body').on('click','.delete-sub-category', function(){
    ...
    {
      var id = $(this).attr('id');
      window.location.href = "<?php echo base_url('admin/sub-category/deleted/') ?>"+id+" ";
    }
  });
</script>